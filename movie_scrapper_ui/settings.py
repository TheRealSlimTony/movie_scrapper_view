"""
Django settings for movie_scrapper_ui project.
...
SECRET_KEY = 'django-insecure-rf=d%aed=_g1dy*q3-%c0c0wx_!kol@b-()cw(j0g5=w$b5xlb'
...
ROOT_URLCONF = 'movie_scrapper_ui.urls'
...
WSGI_APPLICATION = 'movie_scrapper_ui.wsgi.application'
